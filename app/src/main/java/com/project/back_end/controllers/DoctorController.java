...
//    - Inject the shared `AppService` class for general-purpose features like token validation and filtering.
...
//    - Calls the shared `AppService` to perform filtering logic and returns matching doctors in the response.
