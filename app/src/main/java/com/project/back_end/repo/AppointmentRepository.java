...
public interface AppointmentRepository extends JpaRepository<Appointment, Long> {
   ...
   //      - This method retrieves all appointments for a patient with a specific status.
   //      - Return type: List<Appointment>
   //      - Parameters: Long patientId, int status
   List<Appointment> findByPatient_IdAndStatus(Long patientId, int status);

   //    - **findByDoctorNameAndPatientId**:
   //      - This method retrieves appointments filtered by doctor name and patient ID.
   //      - Return type: List<Appointment>
   ...
   //    - **findByDoctorNameAndPatientIdAndStatus**:
   //      - This method retrieves appointments filtered by doctor name, patient ID, and status.
   //      - Return type: List<Appointment>
   ...
   List<Appointment> findByDoctorNameAndPatientIdAndStatus(@Param("doctorName") String doctorName, @Param("patientId") Long patientId, @Param("status") int status);
