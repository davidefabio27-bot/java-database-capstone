...
//    - It also calculates custom fields: 'appointmentDate', 'appointmentTimeOnly', and 'endTime' based on the 'appointmentTime' field.
 ...
 /**
     * Constructor:
     * Initializes core fields and automatically computes:
     * - appointmentDate (date part)
     * - appointmentTimeOnly (time part)
     * - endTime = appointmentTime + 1 hour
     */
    public AppointmentDTO(Long id,
        ...
        // Compute derived fields exactly as required
