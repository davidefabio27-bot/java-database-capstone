...
public List<String> getDoctorAvailability(Long doctorId, LocalDate date) {
    // Logic to fetch booked appointments and return available slots
...
@Transactional
    public int saveDoctor(Doctor doctor) {
        ...
        // Return -1 if exists, 1 if success, 0 if error
...
@Transactional
    public int updateDoctor(Doctor doctor) {
        // Update doctor if exists, else return -1
        return 0; // placeholder
    }
...
@Transactional
    public int deleteDoctor(long id) {
        // Delete all appointments of doctor and then doctor
        return 0; // placeholder
    }
...
@Transactional
    public ResponseEntity<Map<String, String>> validateDoctor(Login login) {
        ...
        // Validate email and password, generate token if valid
...
private List<Doctor> filterDoctorByTime(List<Doctor> doctors, String amOrPm) {
    // Logic to filter doctors by AM/PM availability
    return doctors; // placeholder
}
