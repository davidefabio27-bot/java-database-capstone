...
async function loadAppointments() {
    try {
      ...
      // Step 2: Estrarre la lista degli appuntamenti dall'oggetto restituito
      const appointments = response.appointments || [];
  
      // Step 3: Pulire il contenuto della tabella
      tableBody.innerHTML = "";
      ...
      // Step 5: Itera sugli appuntamenti e crea le righe
      appointments.forEach(app => {
        // Qui passiamo l'intero oggetto app al row creator
        const row = createPatientRecordRow(app);
