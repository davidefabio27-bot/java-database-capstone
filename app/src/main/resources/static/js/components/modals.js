...
export function openModal(type) {
  ...
  // Qui viene fatta la sola modifica: wrap del contenuto nel div .modal-content
  document.getElementById('modal-body').innerHTML = `<div class="modal-content">${modalContent}</div>`;
  document.getElementById('modal').style.display = 'flex'; // flex per centrare come nel CSS
