export function openModal(type) {
    ...
    if (type === 'addDoctor') {
      modalContent = `
        ...
        <input type="email" id="doctorEmailAdd" placeholder="Email" class="input-field">
        <input type="password" id="doctorPasswordAdd" placeholder="Password" class="input-field">
    ...
    // Wrap nel div .modal-content
    document.getElementById('modal-body').innerHTML = `<div class="modal-content">${modalContent}</div>`;
